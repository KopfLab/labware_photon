...
#define STATE_LOG_WEBHOOK     "state_log"  // name of the webhook to device state log
...
#define DATA_LOG_WEBHOOK      "data_log"  // name of the webhook to device data log
...
static void getInfoIdxKeyValueSigmaUnitsNumberTimeOffset(char* target, int size, int idx, char* key, char* value, char* sigma, char* units, int n, unsigned long time_offset, char* pattern = PATTERN_IKVSUNT_JSON) {
  snprintf(target, size, pattern, idx, key, value, sigma, units, n, time_offset);
}

static void getInfoKeyValueSigmaUnitsNumberTimeOffset(char* target, int size, char* key, char* value, char* sigma, char* units, int n, unsigned long time_offset, char* pattern = PATTERN_IKVSUNT_JSON) {
  snprintf(target, size, pattern, key, value, sigma, units, n, time_offset);
}

static void getInfoIdxKeyValueUnitsNumberTimeOffset(char* target, int size, int idx, char* key, char* value, char* units, int n, unsigned long time_offset, char* pattern = PATTERN_IKVUNT_JSON) {
...
static void getInfoIdxKeyValueUnits(char* target, int size, int idx, char* key, char* value, char* units, char* pattern = PATTERN_IKVU_SIMPLE) {
...
static void getInfoIdxKeyValue(char* target, int size, int idx, char* key, char* value, char* pattern = PATTERN_IKV_SIMPLE) {
...
static void getDataDoubleWithSigmaText(int idx, char* key, double value, double sigma, char* units, int n, unsigned long time_offset, char* target, int size, char* pattern, int decimals) {
  char value_text[20];
...
static void getDataDoubleWithSigmaText(int idx, char* key, double value, double sigma, char* units, int n, char* target, int size, char* pattern, int decimals) {
...
static void getDataDoubleText(int idx, char* key, double value, char* units, int n, unsigned long time_offset, char* target, int size, char* pattern, int decimals) {
  char value_text[20];
  print_to_decimals(value_text, sizeof(value_text), value, decimals);
  (idx >= 0) ?
...
static void getDataDoubleText(int idx, char* key, double value, char* units, int n, char* target, int size, char* pattern, int decimals) {
  getDataDoubleText(idx, key, value, units, n, -1, target, size, pattern, decimals);
}

static void getDataDoubleText(int idx, char* key, double value, char* units, char* target, int size, char* pattern, int decimals) {
