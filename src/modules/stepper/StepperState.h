...
struct StepperState : public LoggerState {
  ...
  StepperState(bool locked, bool state_logging, bool data_logging, uint data_logging_period, uint8_t data_logging_type, int direction, int status, float rpm) :
    LoggerState(locked, state_logging, data_logging, data_logging_period, data_logging_type), direction(direction), ms_auto(true), ms_index(-1), status(status), rpm(rpm) {};
  ...
  StepperState(bool locked, bool state_logging, bool data_logging, uint data_logging_period, uint8_t data_logging_type, int direction, int status, float rpm, int ms_index) :
    LoggerState(locked, state_logging, data_logging, data_logging_period, data_logging_type), direction(direction), ms_auto(false), ms_index(ms_index), status(status), rpm(rpm){};
};
