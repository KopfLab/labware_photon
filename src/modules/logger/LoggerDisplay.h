...
class LoggerDisplay : public LiquidCrystal_I2C {
private:
...
public:
	...
	LoggerDisplay (uint8_t lcd_Addr, uint8_t lcd_cols, uint8_t lcd_lines) :
...
// default instances
LoggerDisplay LCD_16x2 (0x3f, 16, 2);
LoggerDisplay LCD_20x4 (0x27, 20, 4);
LoggerDisplay LCD_20x4_0x3f (0x3f, 20, 4);
